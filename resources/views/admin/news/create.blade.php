...
<head>
    ...
    <title>Create News - Admin Dashboard</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="page-header">
            <div>
                <h1>Create News</h1>
                <p class="mb-0">Add a new news article or announcement</p>
            </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('category') is-invalid @enderror" 
                                ...
                                <option value="announcements" {{ old('category') == 'announcements' ? 'selected' : '' }}>
                                    Announcements
                                </option>
    ...
    <script>
        ...
        ClassicEditor
            ...
            .then(editor => {
                ...
                // Remove required attribute dari textarea yang disembunyikan
                const textarea = document.querySelector('#content');
                textarea.removeAttribute('required');
                
                // Update textarea setiap kali content berubah
        ...
        // Handle form submit dengan validasi manual
        document.querySelector('form').addEventListener('submit', function(e) {
            ...
            if (editorInstance) {
                ...
                // Update textarea dengan content dari CKEditor
                textarea.value = editorData;
                
                // Validasi manual untuk content
                if (!editorData.trim()) {
                    e.preventDefault(); // Stop form submission
                    
                    // Alert dengan styling yang sesuai dark theme
                ...
                console.log('CKEditor content updated:', editorData.substring(0, 100) + '...');
            }
        });
        ...
        // Auto-populate publish date when status changes to published
